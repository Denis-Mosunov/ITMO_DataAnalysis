...
namespace SpamDetector
{
    ...
    {
        /// <summary>
        /// model input class for MLSpamDetectModel.
        /// </summary>
        ...
        /// <summary>
        /// model output class for MLSpamDetectModel.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("MLSpamDetectModel.mlnet");
